...
force ace_medical_litterCleanUpDelay = 1163.76;
force ace_medical_litterSimulationDetail = 3;
force ace_medical_maxReviveTime = 629.681;
...
force force ace_weather_updateInterval = 30.1916;
