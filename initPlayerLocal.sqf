...
_player addAction["<t color='#FFFFFF'>Get keys</t>",{_this call HG_fnc_searchForKeys},"",0,false,true,"",'(alive player) AND (vehicle player != player) AND (player == driver vehicle player)'];
