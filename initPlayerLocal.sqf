...
_player addAction["<t color='#FFFFFF'>Get keys</t>",{_this call HG_fnc_searchForKeys},"",0,false,true,"",'[vehicle player,player] call HG_fnc_canGetKeys'];
_player addAction["<t color='#FFFFFF'>Link your key with car</t>",{_this call HG_fnc_searchForKeys},"",0,false,true,"",'[vehicle player,player] call HG_fnc_canLinkKeys'];
